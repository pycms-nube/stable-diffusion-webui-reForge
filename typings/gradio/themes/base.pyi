...
class ThemeClass:
    ...
    @classmethod
    def from_hub(cls, repo_name: str, hf_token: str | None = ...): # -> ThemeClass:
    ...
    def push_to_hub(self, repo_name: str, org_name: str | None = ..., version: str | None = ..., hf_token: str | None = ..., theme_name: str | None = ..., description: str | None = ..., private: bool = ...): # -> str:
...
class Base(ThemeClass):
    def __init__(self, *, primary_hue: colors.Color | str = ..., secondary_hue: colors.Color | str = ..., neutral_hue: colors.Color | str = ..., text_size: sizes.Size | str = ..., spacing_size: sizes.Size | str = ..., radius_size: sizes.Size | str = ..., font: fonts.Font | str | Iterable[fonts.Font | str] = ..., font_mono: fonts.Font | str | Iterable[fonts.Font | str] = ...) -> None:
        """
        Parameters:
