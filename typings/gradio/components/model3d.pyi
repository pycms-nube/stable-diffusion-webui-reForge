...
from gradio.events import Changeable, Clearable, Editable, Uploadable

"""gr.Model3D() component."""
@document()
class Model3D(Changeable, Uploadable, Editable, Clearable, IOComponent, FileSerializable):
    """
    ...
    """
    def __init__(self, value: str | Callable | None = ..., *, clear_color: list[float] | None = ..., label: str | None = ..., every: float | None = ..., show_label: bool | None = ..., container: bool = ..., scale: int | None = ..., min_width: int = ..., visible: bool = ..., elem_id: str | None = ..., elem_classes: list[str] | str | None = ..., **kwargs) -> None:
        """
        Parameters:
