...
from gradio.events import Changeable, Clearable, Selectable, Uploadable

"""gr.File() component"""
@document()
class File(Changeable, Selectable, Clearable, Uploadable, IOComponent, FileSerializable):
    """
    ...
    """
    def __init__(self, value: str | list[str] | Callable | None = ..., *, file_count: Literal["single", "multiple", "directory"] = ..., file_types: list[str] | None = ..., type: Literal["file", "binary"] = ..., label: str | None = ..., every: float | None = ..., show_label: bool | None = ..., container: bool = ..., scale: int | None = ..., min_width: int = ..., height: int | float | None = ..., interactive: bool | None = ..., visible: bool = ..., elem_id: str | None = ..., elem_classes: list[str] | str | None = ..., **kwargs) -> None:
        """
        Parameters:
